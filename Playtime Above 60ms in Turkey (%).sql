WITH 
  ...
  (
    SELECT
      ...
      SUM(CASE WHEN ( direct_rtt > 60 AND direct_rtt < 500 ) THEN 10.0/3600.0 ELSE 0.0 END) as direct_hours_above_60ms,
      SUM(CASE WHEN ( IF(next_rtt>0, next_rtt, direct_rtt) > 60 AND IF(next_rtt>0, next_rtt, direct_rtt) < 500 ) THEN 10.0/3600.0 ELSE 0.0 END) as next_hours_above_60ms,
    FROM
